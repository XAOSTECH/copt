...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/copt.git`
3. Add upstream remote: `git remote add upstream https://github.com/XAOSTECH/copt.git`
...
Feel free to open a [Discussion](https://github.com/XAOSTECH/copt/discussions) for questions or ideas.
